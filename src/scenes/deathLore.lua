...
function deathLore:resetPage(page)
  currentPage = page
  charIndex = 0
  charTimer = 0
  displayedText = ""
...
function deathLore:mousepressed()
  self:keypressed()
end
